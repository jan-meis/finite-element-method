classdef BilinearAnsatzfunction
    ...
    methods
        ...
        function [erg] = gradient(obj, x, y)
            ...
            if (((obj.Px - obj.h) <= x - epsilon) && (x < obj.Px) ...
                    && ((obj.Py - obj.h) <= y - epsilon) && (y< obj.Py))
                erg = [1.0/obj.h - obj.Py/(obj.h*obj.h) + y/(obj.h*obj.h), ...
                    1.0/obj.h - obj.Px/(obj.h*obj.h) + x/(obj.h*obj.h)];
                
            elseif ((obj.Px <= x ) && (x + epsilon <= (obj.Px+obj.h)) ...
                    && ((obj.Py - obj.h) <= y - epsilon) && (y < obj.Py))
                erg = [-1.0/obj.h + obj.Py/(obj.h*obj.h) - y/(obj.h*obj.h), ...
                    1.0/obj.h + obj.Px/(obj.h*obj.h) - x/(obj.h*obj.h)];
                
            elseif (((obj.Px - obj.h) <= x - epsilon ) && (x  < obj.Px) ...
                    && (obj.Py <= y ) && (y + epsilon <= obj.Py+obj.h))
                erg = [1.0/obj.h + obj.Py/(obj.h*obj.h) - y/(obj.h*obj.h), ...
                    -1.0/obj.h + obj.Px/(obj.h*obj.h) - x/(obj.h*obj.h)];
